...
/**
 * AutoAGI Logo icon component.
 *
 * @component IconAutoAGILogo
 * @param {IconProps} props - The props object containing additional attributes and event handlers for the icon.
 * @returns {JSX.Element} - The AutoAGI logo icon.
 */
export const IconAutoAGILogo = createIcon((props) => (
  <svg
    width="89"
    height="40"
    viewBox="0 0 89 40"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    aria-label="AutoAGI Logo"
    {...props}
  >
    <g id="AutoAGI-logo 1" clipPath="url(#clip0_3364_2463)">
      <path
        id="Vector"
