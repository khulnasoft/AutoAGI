...
import {
  StoreAgentsResponse,
  CreatorsResponse,
} from "@/lib/autoagi-server-api/types";
import BackendAPI from "@/lib/autoagi-server-api";
...
export const metadata: Metadata = {
  title: "Marketplace - NextGen AutoAGI",
  description: "Find and use AI Agents created by our community",
  applicationName: "NextGen AutoAGI Store",
  authors: [{ name: "AutoAGI Team" }],
  keywords: [
    "AI agents",
    "automation",
  ...
  openGraph: {
    ...
    description: "Find and use AI Agents created by our community",
    type: "website",
    siteName: "NextGen AutoAGI Store",
    images: [
      {
        url: "/images/store-og.png",
        width: 1200,
        height: 630,
        alt: "NextGen AutoAGI Store",
      },
    ],
  },
  twitter: {
