    ...
    def __init__(self):
        super().__init__(
            ...
            test_mock={
                ...
                "read_pr_changes": lambda *args,
                **kwargs: "List of changes made in the pull request.",
            },
        )
    ...
    def __init__(self):
        super().__init__(
            ...
            test_mock={
                ...
                **kwargs: "Reviewer assigned successfully"
            },
        )
    ...
    def __init__(self):
        super().__init__(
            ...
            test_mock={
                ...
                **kwargs: "Reviewer unassigned successfully"
            },
        )
