    ...
    def __init__(self):
        super().__init__(
            ...
            test_mock={
                ...
                style_type,
                negative_prompt,
                color_palette_name: "https://ideogram.ai/api/images/test-generated-image-url.png",
                "upscale_image": lambda api_key,
                image_url: "https://ideogram.ai/api/images/test-upscaled-image-url.png",
            },
