...
import autoagi_libs.auth.depends
import autoagi_libs.auth.middleware
import fastapi
...
@router.post(
    "/profile",
    tags=["store", "private"],
    dependencies=[fastapi.Depends(autoagi_libs.auth.middleware.auth_middleware)],
...
async def review_submission(
    ...
    user: typing.Annotated[
        autoagi_libs.auth.models.User,
        fastapi.Depends(autoagi_libs.auth.depends.requires_admin_user),
    ],
):
