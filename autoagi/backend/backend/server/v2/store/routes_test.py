...
app.dependency_overrides[autoagi_libs.auth.middleware.auth_middleware] = (
    override_auth_middleware
)
app.dependency_overrides[autoagi_libs.auth.depends.get_user_id] = override_get_user_id
